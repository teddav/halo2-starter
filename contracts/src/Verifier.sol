...
contract Halo2Verifier {
    ...
    uint256 internal constant NUM_INSTANCE_CPTR = 0x0524;
    uint256 internal constant     INSTANCE_CPTR = 0x0544;
    ...
    uint256 internal constant CHALLENGE_MPTR = 0x0940;

    uint256 internal constant THETA_MPTR = 0x0940;
    uint256 internal constant  BETA_MPTR = 0x0960;
    uint256 internal constant GAMMA_MPTR = 0x0980;
    uint256 internal constant     Y_MPTR = 0x09a0;
    uint256 internal constant     X_MPTR = 0x09c0;
    uint256 internal constant  ZETA_MPTR = 0x09e0;
    uint256 internal constant    NU_MPTR = 0x0a00;
    uint256 internal constant    MU_MPTR = 0x0a20;

    uint256 internal constant       ACC_LHS_X_MPTR = 0x0a40;
    uint256 internal constant       ACC_LHS_Y_MPTR = 0x0a60;
    uint256 internal constant       ACC_RHS_X_MPTR = 0x0a80;
    uint256 internal constant       ACC_RHS_Y_MPTR = 0x0aa0;
    uint256 internal constant             X_N_MPTR = 0x0ac0;
    uint256 internal constant X_N_MINUS_1_INV_MPTR = 0x0ae0;
    uint256 internal constant          L_LAST_MPTR = 0x0b00;
    uint256 internal constant         L_BLIND_MPTR = 0x0b20;
    uint256 internal constant             L_0_MPTR = 0x0b40;
    uint256 internal constant   INSTANCE_EVAL_MPTR = 0x0b60;
    uint256 internal constant   QUOTIENT_EVAL_MPTR = 0x0b80;
    uint256 internal constant      QUOTIENT_X_MPTR = 0x0ba0;
    uint256 internal constant      QUOTIENT_Y_MPTR = 0x0bc0;
    uint256 internal constant       G1_SCALAR_MPTR = 0x0be0;
    uint256 internal constant   PAIRING_LHS_X_MPTR = 0x0c00;
    uint256 internal constant   PAIRING_LHS_Y_MPTR = 0x0c20;
    uint256 internal constant   PAIRING_RHS_X_MPTR = 0x0c40;
    uint256 internal constant   PAIRING_RHS_Y_MPTR = 0x0c60;
    ...
    function verifyProof(
        ...
        assembly {
...

            {
                ...
                success := and(success, eq(0x04a0, calldataload(PROOF_LEN_CPTR)))
                ...
                extcodecopy(vk, VK_MPTR, 0x00, 0x03a0)
            ...
            // Compute quotient evavluation
            {
                ...
                let y := mload(Y_MPTR)
                {
                    ...
                    let var0 := addmod(a_0, a_0_next_1, r)
                    let a_0_next_2 := calldataload(0x0304)
                    let var1 := sub(r, a_0_next_2)
                ...
                }
                {
                    ...
                    let eval := addmod(l_0, sub(r, mulmod(l_0, calldataload(0x03c4), r)), r)
                    quotient_eval_numer := addmod(mulmod(quotient_eval_numer, y, r), eval, r)
                }
                {
                    let perm_z_last := calldataload(0x03c4)
                ...
                }
                {
                    ...
                    let lhs := calldataload(0x03e4)
                    let rhs := calldataload(0x03c4)
                    lhs := mulmod(lhs, addmod(addmod(calldataload(0x02c4), mulmod(beta, calldataload(0x0384), r), r), gamma, r), r)
                    lhs := mulmod(lhs, addmod(addmod(mload(INSTANCE_EVAL_MPTR), mulmod(beta, calldataload(0x03a4), r), r), gamma, r), r)
                ...
                {
                    let l_0 := mload(L_0_MPTR)
                    let eval := addmod(l_0, mulmod(l_0, sub(r, calldataload(0x0404)), r), r)
                    quotient_eval_numer := addmod(mulmod(quotient_eval_numer, y, r), eval, r)
                }
                {
                    let l_last := mload(L_LAST_MPTR)
                    let eval := mulmod(l_last, addmod(mulmod(calldataload(0x0404), calldataload(0x0404), r), sub(r, calldataload(0x0404)), r), r)
                    quotient_eval_numer := addmod(mulmod(quotient_eval_numer, y, r), eval, r)
                }
                {
                    ...
                    let beta := mload(BETA_MPTR)
                    let gamma := mload(GAMMA_MPTR)
                    let lhs := mulmod(calldataload(0x0424), mulmod(addmod(calldataload(0x0444), beta, r), addmod(calldataload(0x0484), gamma, r), r), r)
                    let rhs := mulmod(calldataload(0x0404), mulmod(addmod(input, beta, r), addmod(table, gamma, r), r), r)
                    let eval := mulmod(addmod(1, sub(r, addmod(mload(L_BLIND_MPTR), mload(L_LAST_MPTR), r)), r), addmod(lhs, sub(r, rhs), r), r)
                    quotient_eval_numer := addmod(mulmod(quotient_eval_numer, y, r), eval, r)
                }
                {
                    let eval := mulmod(mload(L_0_MPTR), addmod(calldataload(0x0444), sub(r, calldataload(0x0484)), r), r)
                    quotient_eval_numer := addmod(mulmod(quotient_eval_numer, y, r), eval, r)
                }
                {
                    let eval := mulmod(addmod(1, sub(r, addmod(mload(L_BLIND_MPTR), mload(L_LAST_MPTR), r)), r), mulmod(addmod(calldataload(0x0444), sub(r, calldataload(0x0484)), r), addmod(calldataload(0x0444), sub(r, calldataload(0x0464)), r), r), r)
                    quotient_eval_numer := addmod(mulmod(quotient_eval_numer, y, r), eval, r)
                }
            ...
            // Compute pairing lhs and rhs
            {
                ...
                }
                {
                    ...
                    mstore(0x0460, diff)
                    diff := mload(0x0380)
                    diff := mulmod(diff, mload(0x03c0), r)
                    diff := mulmod(diff, mload(0x03e0), r)
                    mstore(0x0480, diff)
                }
                {
                ...
                }
                {
                    ...
                    let r_eval
                    r_eval := addmod(r_eval, mulmod(mload(0x20), calldataload(0x02c4), r), r)
                ...
                }
                {
                    let zeta := mload(ZETA_MPTR)
                    let r_eval
                    r_eval := addmod(r_eval, mulmod(mload(0x80), calldataload(0x0404), r), r)
                    r_eval := addmod(r_eval, mulmod(mload(0xa0), calldataload(0x0424), r), r)
                ...
                }
                {
                    ...
                    r_eval := addmod(r_eval, mulmod(mload(0xe0), calldataload(0x0444), r), r)
                    r_eval := mulmod(r_eval, mload(0x0460), r)
                    mstore(0x04e0, r_eval)
                }
                {
                    let coeff := mload(0x0100)
                    let zeta := mload(ZETA_MPTR)
                    let r_eval
                    r_eval := mulmod(coeff, calldataload(0x0364), r)
                    r_eval := mulmod(r_eval, zeta, r)
                ...
                }
                {
                    ...
                    mstore(0x80, calldataload(0xc4))
                    mstore(0xa0, calldataload(0xe4))
                    ...
                    success := ec_mul_tmp(success, zeta)
                    success := ec_add_tmp(success, calldataload(0x0104), calldataload(0x0124))
                    ...
                    mstore(PAIRING_RHS_X_MPTR, calldataload(0x04e4))
                    mstore(PAIRING_RHS_Y_MPTR, calldataload(0x0504))
                }
            }
